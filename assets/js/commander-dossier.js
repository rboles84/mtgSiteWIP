...
export const COMMANDER_FACTION_GUIDANCE = {
  ...
  BANT: {
    ...
    spellcraftIdentity: "Look for exalted, auras, equipment, blink, ETB value, enchantress, Clues, counters, and protection that reinforce public trust and refined communal order.",
  ...
  GRIXIS: {
    ...
    spellcraftIdentity: "Look for removal, discard, sacrifice, spell recursion, card draw, and pressure pieces that express survival, calculation, and urgency.",
  ...
  JUND: {
    ...
    spellcraftIdentity: "Look for devour, sacrifice, graveyard value, lands, counters, tokens, combat pressure, and value engines that express appetite, survival, and consequence.",
