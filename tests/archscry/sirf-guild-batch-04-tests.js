...
const contracts = {
  UB: {
    contractFile: "dimir.json",
    taxonomy: ["Hidden Information Leverage", "Surveil Filtering", "Covert Infiltration"],
    rawPrefix: "data/raw-factions/house_dimir/",
    native: [],
    downgradedExact: ["Sneak Attack", "Mind Flayarrrs", "Revenant Recon", "Fae Dominion", "Undead Unleashed"],
  },
  RG: {
    contractFile: "gruul.json",
    taxonomy: ["Wild Reclamation", "Clan-Fed Pressure", "Riot Momentum"],
    rawPrefix: "data/raw-factions/gruul_clans/",
    native: [],
    downgradedExact: ["Draconic Destruction", "Exit From Exile", "Upgrades Unleashed"],
  },
  WG: {
    contractFile: "selesnya.json",
    taxonomy: ["Convoke Community", "Go-Wide Caretaking", "Harmony and Preservation"],
    rawPrefix: "data/raw-factions/selesnya_conclave/",
    native: ["Token Triumph"],
    downgradedExact: ["Virtue and Valor", "Coven Counters"],
  },
  UR: {
    contractFile: "izzet.json",
    taxonomy: ["Prototype Velocity", "Jump-Start Iteration", "Overload Breakthrough"],
    rawPrefix: "data/raw-factions/izzet_league/",
    native: ["Seize Control"],
    downgradedExact: ["Quick Draw", "Draconic Dissent"],
  },
  BG: {
    contractFile: "golgari.json",
    taxonomy: ["Reclamation Midrange", "Graveyard Resource Loops", "Undergrowth and Renewal"],
    rawPrefix: "data/raw-factions/golgari_swarm/",
    native: [],
    downgradedExact: ["Death Toll", "Plunder the Graves"],
  },
};
...
for (const [key, expected] of Object.entries(contracts)) {
  ...
  assert.equal(authored.copy_sha256, expectedHash, `${key} authored copy hash must be fresh.`);
...
console.log("SIRF guild batch 04 focused tests passed for Dimir, Gruul, Selesnya, Izzet, and Golgari.");
