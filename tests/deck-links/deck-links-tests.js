...
} from "../../assets/js/archscry/deck-links.js";
import {
  archiveUserDeckLink,
...
} from "../../assets/js/archscry/deck-link-service.js";
...
const communityLedgerSource = await readFile(new URL("../../assets/js/apocrypha/community-deck-ledger.js", import.meta.url), "utf8");
