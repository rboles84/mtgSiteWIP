...
import { createDictionaryFromSeed, getScryfallDictionaryVocabulary } from "../../assets/js/maze/scryfall-dictionary.js";
import { parseScryfallNaturalLanguage, setScryfallDictionary } from "../../assets/js/maze/scryfall-parser.js";
import { setPlainReadingSemanticRegistry, setScryfallGrounding } from "../../assets/js/maze/scryfall-grounded-compiler.js";

const seed = JSON.parse(await readFile(new URL("../../data/maze/scryfall-parser-seed-2026.json", import.meta.url), "utf8"));
