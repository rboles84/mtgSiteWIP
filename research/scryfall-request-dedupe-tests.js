...
try {
  const { scryfallSearch, scryfallExact } = await import("./research-search.js");
  const { loadCachedScryfallNamedCard } = await import(new URL("../assets/js/index.js", import.meta.url).href);
