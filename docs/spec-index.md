...
| [Data Flow Map](data-flow-map.md) | Data lineage and storage map. | Tracing raw inputs to generated artifacts, browser state, Supabase, Scryfall, Anthropic, and test output. |
...
| [Manual Test Cases](manual-test-cases.md) | Human QA flow. | Verifying quick reading, interview, save/resume, failures, and mobile sanity. |
