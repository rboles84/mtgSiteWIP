...
**VM-502 Prismari, VM-506 Lorehold, VM-503 Quandrix, VM-504 Silverquill, VM-505 Witherbloom, VM-507 Izzet, VM-508 Azorius, VM-509 Boros, VM-510 Rakdos, VM-511 Golgari, VM-512 Gruul, VM-513 Dimir, VM-514 Orzhov, VM-515 Selesnya, and VM-516 Simic are certified semantically ready under CRIT-001 Contract v1.1.** Simic approved replacement candidate `bcc12c170e3d09fecd5b15c6ade07cef94ce7e1e` is certified after fresh independent review `214ed8182207521bb6750e35f57f67d41325b438`; rejected candidate `cbca9f596a090e924d532e7cb657c27c79ccb9de` and superseded candidates `f4afb9d5d769c72e1c86df189729423a380629af` and `204cf9e6be15f2c3ac59a36c3977efea9a9945ce` remain unapproved. Candidate-scope exit `1` is recorded as `PASS - approved documented UG display-source exception` for the UG identity-layer preview source and embedded consumer. Wave 2 Ravnica is complete: 10 of 10 guild identities certified, total certified identities 15. VM-540 adds CRIT-001 Operating Playbook v2 and Gate 0 hardening. Active identity is VM-517 White / W on branch `codex/vm-517-white-semantic-recovery`; the original White drift preflight stopped on a Wave 3 monocolor candidate-scope validator incompatibility, then shared infrastructure candidate `aa1f5cd174a09c7c99e17e3ecf882bf4e03dbdb2` was independently approved by exact-SHA review. The later VM-517 drift-preflight rerun passed with no `FAIL` or `UNKNOWN`; Gate 1+2 is complete in `docs/incidents/recoveries/VM-517-white-semantic-recovery.md` and records `REMEDIATION AUTHORIZED`. White remediation/generation may proceed under Gate 3+4, while candidate review, certification, program-base advancement, external tracker update, and VM-518 work remain unauthorized/not started.
...
- [VM-517 - White Semantic Recovery](backlog/VM-517-white-semantic-recovery.md) - Gate 1+2 read-only audit completed and records `REMEDIATION AUTHORIZED`; Gate 3+4 remediation/generation may proceed. White candidate review, certification, semantically_ready, program-base advancement, external tracker update, and VM-518 work remain unauthorized/not started.
