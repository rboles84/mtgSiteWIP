...
- [VM-526 - Naya Semantic Recovery](in-progress/VM-526-naya-semantic-recovery.md) - drift preflight passed from exact VM-525 certification/program base `7964b93f531017e579f069e6941463f53eab4bd9`; `NAYA` confirmed as canonical key, `WRG` rejected as invalid candidate-scope alias; Gate 1+2 read-only semantic audit is authorized, while remediation/candidate/review/certification remain unstarted.
