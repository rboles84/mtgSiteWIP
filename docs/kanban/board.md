...
- [VM-520 - Red Semantic Recovery](backlog/VM-520-red-semantic-recovery.md) - Gate 1+2 read-only audit completed after the Red drift preflight and records `REMEDIATION AUTHORIZED`; candidate, review, certification, and VM-521 remain not started.
