...
- [VM-524 - Grixis Semantic Recovery](in-progress/VM-524-grixis-semantic-recovery.md) - Gate 3+4 semantic remediation complete at `docs/handoffs/2026-07-20-2358-codex-vm524-grixis-gate3-gate4.md` with implementation HEAD `64a5bfffd646b292c7481f91c9ccb6def42fb552`; Gate 5 candidate creation is authorized for a later separate prompt; no candidate, review, certification, Excel edit, VM-525 work, CRIT ledger edit, or program-base advancement occurred.
