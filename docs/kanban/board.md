...
- [VM-538 - WUBRG Semantic Recovery](in-progress/VM-538-wubrg-semantic-recovery.md) - Gate 1+2 complete from exact program base `7f615d4fe5a19cf8f9d2a58a8026f837378c06b2`; WUBRG-only Gate 3+4 remediation is authorized under Contract v1.1; no candidate, review, certification, or Excel update exists.
