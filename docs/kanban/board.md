...
- [VM-521 - Green Semantic Recovery](backlog/VM-521-green-semantic-recovery.md) - Gate 1+2 read-only audit is complete with `REMEDIATION AUTHORIZED`; scoped Green remediation may proceed under frozen-field, exact-chain, preview, neighbor, candidate-scope, and Table Talk controls.
