...
- [VM-518 - Blue Semantic Recovery](backlog/VM-518-blue-semantic-recovery.md) - Gate 3+4 remediation and Gate 5 candidate complete. Exact candidate `ac774e2eac207cc7fe2d744beac1f11788908159` awaits independent review. Not approved, not certified, not semantically_ready; VM-519 and external tracker updates remain not started.
