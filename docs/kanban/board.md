...
- [VM-517 - White Semantic Recovery](backlog/VM-517-white-semantic-recovery.md) - Final candidate `89535e5f73598a5b518e31e11598b05087274a95` created and awaiting independent review; superseded candidate `8d6014950e5ca45ef85a90855cf283d80fd18e0d` remains recorded as a candidate-scope failure. White is not approved, not certified, not semantically_ready; program-base advancement, external tracker update, and VM-518 work remain unauthorized/not started.
