...
- [VM-527 - Abzan Semantic Recovery](in-progress/VM-527-abzan-semantic-recovery.md) - Gate 1+2 read-only audit complete; Gate 3+4 remediation authorized, with no semantic remediation or candidate yet.
