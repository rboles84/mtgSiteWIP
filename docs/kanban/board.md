...
- [VM-517 - White Semantic Recovery](backlog/VM-517-white-semantic-recovery.md) - governance hold after drift preflight; shared infrastructure candidate `aa1f5cd174a09c7c99e17e3ecf882bf4e03dbdb2` is independently approved and removes the monocolor validator crash. White Gate 1+2 remains not authorized pending a separate drift-preflight rerun; no White source inspection, semantic audit, remediation, candidate, review, certification, or VM-518 work started.
