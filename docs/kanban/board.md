...
- [VM-536 - Witch Semantic Recovery](in-progress/VM-536-witch-semantic-recovery.md) - Gate 1+2 governance recorded at `docs/handoffs/2026-07-24-1744-codex-vm536-witch-gate1-gate2.md`; WITCH-only Gate 3+4 remediation authorized; VM-537 Colorless and VM-538 WUBRG remain untouched.
