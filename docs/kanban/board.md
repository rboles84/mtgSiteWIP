...
**VM-502 Prismari, VM-506 Lorehold, VM-503 Quandrix, VM-504 Silverquill, VM-505 Witherbloom, VM-507 Izzet, VM-508 Azorius, VM-509 Boros, VM-510 Rakdos, VM-511 Golgari, VM-512 Gruul, VM-513 Dimir, VM-514 Orzhov, VM-515 Selesnya, VM-516 Simic, VM-517 White, VM-518 Blue, VM-519 Black, VM-520 Red, VM-521 Green, VM-522 Bant, VM-523 Esper, VM-524 Grixis, VM-525 Jund, and VM-526 Naya are certified semantically ready under CRIT-001 Contract v1.1.** Naya exact candidate `f3dda547eb91475cd3d00056463729d98a040e55` is certified after independent exact-SHA review decision `APPROVE EXACT SHA f3dda547eb91475cd3d00056463729d98a040e55` at `8afaa199d774d56845a305c4f879d275ada94a47`; candidate workflow record `cdcd1b408a64dacb63e75865c519ca317ce0e08a` remains distinct from the semantic candidate. Wave 2 Ravnica is complete: 10 of 10 guild identities certified. Wave 3 monocolors are complete: 5 of 5 certified. Wave 4 shards are active: 5 of 10 certified, total certified identities 25. Current program base is the VM-526 certification commit `PENDING_VM526_CERTIFICATION_COMMIT_SHA`; the prior program base was the VM-525 certification commit `7964b93f531017e579f069e6941463f53eab4bd9`. DRIFT-020 exact infrastructure candidate `399ba34243f5b421da4d3a0c251a37bcbc4bd5fa` remains certified and distinct. Superseded Naya candidate `57ce7161c1ff8736a8b91a6564fa97129fe38383` remains recorded and unapproved. VM-527 Abzan semantic candidate `11c099b8beb9f23e23660787f00b97e89914d50b` received independent review decision `APPROVE EXACT SHA 11c099b8beb9f23e23660787f00b97e89914d50b` and is awaiting certification-only governance; no certification, Excel edit, VM-528 work, push, PR, or merge has occurred.
...
- [VM-527 - Abzan Semantic Recovery](in-progress/VM-527-abzan-semantic-recovery.md) - exact candidate `11c099b8beb9f23e23660787f00b97e89914d50b` approved by independent review; certification-only governance next.
