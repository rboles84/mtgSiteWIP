...
- [VM-528 - Temur Semantic Recovery](in-progress/VM-528-temur-semantic-recovery.md) - exact semantic candidate `790fca923c504e32911e0be0eb44f7fdbcfb07dc` is independently approved; certification-only work is next. `GUR`, `URG`, and `RGU` remain invalid identity aliases. No certification, Excel edit, VM-529 work, push, PR, or merge has occurred.
