...
- [VM-520 - Red Semantic Recovery](backlog/VM-520-red-semantic-recovery.md) - Exact candidate `deaf7a0bbaf9f2c91d2d00d302a38bef7f07b870` received independent review decision `REQUEST CHANGES`; replacement candidate required for Red-local `JESKAI`, `JUND`, and `NAYA` neighbor coverage; Red is not approved, not certified, and VM-521 remains not started.
...
- VM-520 review note: Red / R exact candidate `deaf7a0bbaf9f2c91d2d00d302a38bef7f07b870` received independent review decision `REQUEST CHANGES`. Review verified Contract/provenance/fixture/frozen-field/preview validation, but approval is blocked because Red-local fixture/collision/recruiter guidance does not cover prompt-required Red-adjacent neighbors `JESKAI`, `JUND`, and `NAYA`. Red is not approved, not certified, not semantically_ready; certified count remains 18, Wave 3 remains 3 of 5, and VM-521 remains not started.
