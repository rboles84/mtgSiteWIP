...
- [VM-529 - Sultai Semantic Recovery](in-progress/VM-529-sultai-semantic-recovery.md) - exact semantic candidate `a92fb3f8a0ec4235d5148b20c4040bd717332ad6` is ready for independent exact-SHA review; no review, certification, semantically_ready transition, program-base change, certified-count change, VM-530, or Excel work has occurred.
