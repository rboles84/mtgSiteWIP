...
- [VM-523 - Esper Semantic Recovery](in-progress/VM-523-esper-semantic-recovery.md) - pre-identity drift preflight complete at `docs/handoffs/2026-07-20-0902-codex-vm523-esper-drift-preflight.md`; Gate 1+2 read-only audit authorized but not started; remediation, candidate creation, independent review, certification, program-base advancement, VM-524 work, and Excel edits remain unauthorized.
