...
- [VM-534 - Dune Semantic Recovery](in-progress/VM-534-dune-semantic-recovery.md) - Gate 1+2 recorded; DUNE-only Gate 3+4 remediation authorized from exact program base `ab3ece2155d52c0f4283a0c0244c601a0991f970`.
