...
- [VM-516 - Simic Semantic Recovery](backlog/VM-516-simic-semantic-recovery.md) - Independent review returned `REQUEST CHANGES` for exact candidate `cbca9f596a090e924d532e7cb657c27c79ccb9de`; stale preview-eligible identity-layer public copy must be remediated in a replacement candidate; superseded candidates `f4afb9d5d769c72e1c86df189729423a380629af` and `204cf9e6be15f2c3ac59a36c3977efea9a9945ce` remain unapproved; not certified; not semantically_ready; VM-517 not started.
