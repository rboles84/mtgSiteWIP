...
- [VM-531 - Jeskai Semantic Recovery](in-progress/VM-531-jeskai-semantic-recovery.md) - drift preflight recorded from exact program base `9b91bbe0631ecdb45f38823ecc0fdc70bd7c12a2`; Gate 1+2 read-only audit is next and not started; no candidate exists.
