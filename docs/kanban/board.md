...
- [VM-528 - Temur Semantic Recovery](in-progress/VM-528-temur-semantic-recovery.md) - exact semantic candidate `790fca923c504e32911e0be0eb44f7fdbcfb07dc` is ready for independent review. `GUR`, `URG`, and `RGU` remain invalid identity aliases. No independent review, certification, Excel edit, VM-529 work, push, PR, or merge has occurred.
