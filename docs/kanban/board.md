...
- [VM-530 - Mardu Semantic Recovery](in-progress/VM-530-mardu-semantic-recovery.md) - exact candidate `96df085ff38d03da1e37de80b1e11705b1dfa47a` is ready for independent exact-SHA review from program base `7970c14822ce006c0d88f95cc6ed01bb3c79b81f`; independent review, certification, VM-531, Excel, cleanup, push, PR, and merge are not started.
