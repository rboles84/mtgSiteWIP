...
- [VM-526 - Naya Semantic Recovery](ready/VM-526-naya-semantic-recovery.md) - exact candidate `f3dda547eb91475cd3d00056463729d98a040e55` recorded and ready for independent exact-SHA review; canonical key `NAYA`, invalid aliases `WRG`/`RGW`/`GRW`, 10 substantive claims, 20 evidence locators, 13 fixtures, 34 NAYA provenance entries, and exact-tree tests pass; not reviewed or certified.
## In Progress
