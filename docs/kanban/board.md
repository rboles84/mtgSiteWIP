...
- [VM-519 - Black Semantic Recovery](backlog/VM-519-black-semantic-recovery.md) - Gate 5 candidate `5bffc3465786c18950d32dcb6f056504b3b8e668` created after Gate 3+4 remediation and validation; awaiting independent review. Black is not certified and VM-520 remains not started.
