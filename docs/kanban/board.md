...
**VM-502 Prismari, VM-506 Lorehold, VM-503 Quandrix, VM-504 Silverquill, VM-505 Witherbloom, VM-507 Izzet, VM-508 Azorius, VM-509 Boros, VM-510 Rakdos, VM-511 Golgari, VM-512 Gruul, VM-513 Dimir, VM-514 Orzhov, VM-515 Selesnya, VM-516 Simic, VM-517 White, VM-518 Blue, VM-519 Black, VM-520 Red, VM-521 Green, VM-522 Bant, VM-523 Esper, VM-524 Grixis, VM-525 Jund, VM-526 Naya, VM-527 Abzan, VM-528 Temur, and VM-529 Sultai are certified semantically ready under CRIT-001 Contract v1.1.** Sultai exact candidate `a92fb3f8a0ec4235d5148b20c4040bd717332ad6` is certified after independent exact-SHA review decision `APPROVE EXACT SHA a92fb3f8a0ec4235d5148b20c4040bd717332ad6` at `2b469a61656bd2151f4c7e560421afc7c452887b`; candidate workflow record `18c4273abd798e4c3365fb6ce32bdf2a884a1cfc` remains distinct from the semantic candidate. Wave 2 Ravnica is complete: 10 of 10 guild identities certified. Wave 3 monocolors are complete: 5 of 5 certified. Wave 4 shards are active: 8 of 10 certified, 1 in progress, and 1 backlog; total certified identities are 28. Current program base remains the VM-529 certification commit `7970c14822ce006c0d88f95cc6ed01bb3c79b81f`; the prior program base was the VM-528 certification commit `8e23ef467ec7f60daec746c14493173f96d9261c`. DRIFT-020 exact infrastructure candidate `399ba34243f5b421da4d3a0c251a37bcbc4bd5fa` remains certified and distinct. VM-530 Mardu exact candidate `96df085ff38d03da1e37de80b1e11705b1dfa47a` has independent review approval `APPROVE EXACT SHA 96df085ff38d03da1e37de80b1e11705b1dfa47a` and is awaiting certification only; Mardu is not certified and not semantically_ready. VM-531 Jeskai remains backlog, not started, and untouched.
...
- [VM-530 - Mardu Semantic Recovery](in-progress/VM-530-mardu-semantic-recovery.md) - exact candidate `96df085ff38d03da1e37de80b1e11705b1dfa47a` is independently approved from program base `7970c14822ce006c0d88f95cc6ed01bb3c79b81f` with decision `APPROVE EXACT SHA 96df085ff38d03da1e37de80b1e11705b1dfa47a`; certification, VM-531, Excel, cleanup, push, PR, and merge are not started.
