...
**VM-502 Prismari, VM-506 Lorehold, VM-503 Quandrix, VM-504 Silverquill, VM-505 Witherbloom, VM-507 Izzet, VM-508 Azorius, VM-509 Boros, VM-510 Rakdos, VM-511 Golgari, VM-512 Gruul, VM-513 Dimir, VM-514 Orzhov, VM-515 Selesnya, VM-516 Simic, VM-517 White, VM-518 Blue, VM-519 Black, VM-520 Red, VM-521 Green, VM-522 Bant, VM-523 Esper, VM-524 Grixis, and VM-525 Jund are certified semantically ready under CRIT-001 Contract v1.1.** Jund exact candidate `b275fc62aca3ed67bcdc624ea59b3ee15cdeae04` is certified after independent exact-SHA review decision `APPROVE EXACT SHA b275fc62aca3ed67bcdc624ea59b3ee15cdeae04` at `dee26b0246713a9b7d687c9fd2dfb96db2cfd9d2`; candidate workflow record `461ff5c389a93c6c5e5fc7317bbc5413d214a960` remains distinct from the semantic candidate. Wave 2 Ravnica is complete: 10 of 10 guild identities certified. Wave 3 monocolors are complete: 5 of 5 certified. Wave 4 shards are active: 4 of 10 certified, total certified identities 24. Current program base is the VM-525 certification commit `7964b93f531017e579f069e6941463f53eab4bd9`; the prior program base was the DRIFT-020 certification commit `665d2b128f3aab8daf5d48d4fdab244a9fb33c2e`. DRIFT-020 exact infrastructure candidate `399ba34243f5b421da4d3a0c251a37bcbc4bd5fa` remains certified and distinct. Superseded Jund candidate attempts `ba606b702832ce84baf45055562808f9b971e897` and `4a2c6462c4967f661bfa5357805fc155d2d5a746` remain recorded and unapproved. VM-526 Naya exact semantic candidate `f3dda547eb91475cd3d00056463729d98a040e55` has independent exact-SHA approval recorded by decision `APPROVE EXACT SHA f3dda547eb91475cd3d00056463729d98a040e55`; superseded Naya candidate `57ce7161c1ff8736a8b91a6564fa97129fe38383` remains unapproved. Naya certification has not occurred, the program base remains unchanged, certified count remains 24 of 37, and no Excel edit, VM-527 work, push, PR, or merge has occurred.
...
- [VM-526 - Naya Semantic Recovery](ready/VM-526-naya-semantic-recovery.md) - exact candidate `f3dda547eb91475cd3d00056463729d98a040e55` has independent exact-SHA approval recorded; canonical key `NAYA`, invalid aliases `WRG`/`RGW`/`GRW`, 10 substantive claims, 20 evidence locators, 13 fixtures, 34 NAYA provenance entries, exact candidate-scope and exact-tree tests pass; certification-only next, not certified.
## In Progress
