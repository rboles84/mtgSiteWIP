...
- [VM-520 - Red Semantic Recovery](backlog/VM-520-red-semantic-recovery.md) - setup-only after VM-519 Black certification; Red drift preflight is pending and Gate 1+2 semantic work has not started.
