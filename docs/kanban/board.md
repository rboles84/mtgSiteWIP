...
- [VM-532 - Yore Semantic Recovery](in-progress/VM-532-yore-semantic-recovery.md) - exact semantic candidate `f83b8b90b49a7afe3236f3e7f7ab52a254625d1f` qualified from program base `4529f8615785743d074e3060e13f990941c1a458`; awaiting independent exact-SHA review, certification not authorized, and VM-533 remains backlog.
