...
- [VM-537 - Colorless Semantic Recovery](in-progress/VM-537-colorless-semantic-recovery.md) - Gate 1+2 passed from exact program base `8576efbb3e9e16b50684e1ea86214f9beb3b94dd`; bounded COLORLESS-only remediation is authorized before an immutable candidate.
