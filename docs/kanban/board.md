...
- [VM-506 - Lorehold Semantic Recovery](in-progress/VM-506-lorehold-semantic-recovery.md) - active identity after VM-502 acceptance; candidate recovery SHA `c43127858e1a8609e1aed8481c2726ab03026a61` ready for independent review; certification not started.
