...
- [VM-530 - Mardu Semantic Recovery](in-progress/VM-530-mardu-semantic-recovery.md) - drift preflight complete from exact VM-529 certification/program base `7970c14822ce006c0d88f95cc6ed01bb3c79b81f`; Gate 1+2 semantic audit, evidence work, remediation, candidate, independent review, certification, VM-531, Excel, push, PR, and merge are not started.
