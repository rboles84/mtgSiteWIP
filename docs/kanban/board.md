...
- [VM-532 - Yore Semantic Recovery](in-progress/VM-532-yore-semantic-recovery.md) - drift preflight recorded from exact program base `4529f8615785743d074e3060e13f990941c1a458`; Gate 1+2 not started, no semantic remediation, no candidate, and VM-533 remains backlog.
