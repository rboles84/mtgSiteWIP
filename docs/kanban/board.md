...
- [VM-525 - Jund Semantic Recovery](ready/VM-525-jund-semantic-recovery.md) - exact semantic candidate `b275fc62aca3ed67bcdc624ea59b3ee15cdeae04` is independently approved and awaits certification-only work; no certification, semantically_ready transition, certified-count change, or VM-526 work has occurred.
## In Progress
