...
- [VM-531 - Jeskai Semantic Recovery](in-progress/VM-531-jeskai-semantic-recovery.md) - Gate 1+2 read-only audit recorded from drift preflight `bd9e8b6ff1c24511085575451fefe78b31d9c13f`; Gate 3+4 Jeskai-only remediation is authorized next; no candidate exists.
