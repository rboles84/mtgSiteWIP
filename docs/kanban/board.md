...
- [VM-512 - Gruul Semantic Recovery](backlog/VM-512-gruul-semantic-recovery.md) - Replacement candidate `16b58c3f32d92e6406d368169d91b0b6a86f948d` independently approved by exact SHA after duplicate-chain review remediation; awaiting certification; Gruul is not certified; VM-513 has not started.
