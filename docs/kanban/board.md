...
- [VM-522 - Bant Semantic Recovery](ready/VM-522-bant-semantic-recovery.md) - Gate 1+2 read-only semantic audit is complete; Gate 3+4 remediation is authorized under the exact bounded contract; no remediation has occurred, no candidate exists, and review/certification remain unauthorized.
