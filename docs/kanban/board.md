...
- [VM-618 — Move Guide to Topbar Utility and Correct Active Indicator Alignment](in-progress/VM-618-guide-topbar-utility-active-indicator.md) - Owner Review Ready; surgical post-VM-614 shared-navigation refinement moves Guide beside Feedback, preserves one mobile Guide entry/current state, and corrects shared main-nav marker/separator geometry without changing Guide content or VM-615–617.
