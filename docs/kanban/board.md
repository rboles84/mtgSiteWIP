...
- [VM-533 - Glint Semantic Recovery](in-progress/VM-533-glint-semantic-recovery.md) - Gate 1+2 read-only audit complete from exact program base `8145b8697ed1d1500c0faecf080b55404ab8ec4e`; GLINT canonical, `Glint / Chaos` display name, `UBRG` metadata display order, only `GLINT` accepted as alias, UBRG/permutations fail closed, and Gate 3+4 GLINT-only remediation is authorized.
