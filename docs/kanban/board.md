...
- [VM-523 - Esper Semantic Recovery](ready/VM-523-esper-semantic-recovery.md) - exact candidate `6467f70fa4de13173172e20277e0fd56ebaf0b80` is recorded by governance workflow `docs/handoffs/2026-07-20-1641-codex-vm523-esper-candidate-workflow.md`; fresh independent exact-SHA review is required next; no approval, rejection, certification, semantically-ready transition, program-base advancement, VM-524 work, or Excel edit exists.
## In Progress
