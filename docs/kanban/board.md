...
- [VM-517 - White Semantic Recovery](backlog/VM-517-white-semantic-recovery.md) - drift preflight rerun passed after exact validator approval; White Gate 1+2 is authorized but not started. White remediation, generation, candidate, review, certification, program-base advancement, external tracker update, and VM-518 work remain unauthorized/not started.
