...
- [VM-519 - Black Semantic Recovery](backlog/VM-519-black-semantic-recovery.md) - drift preflight passed after VM-518 Blue certification; Gate 1+2 authorized but not started; remediation, candidate, review, and certification not started.
