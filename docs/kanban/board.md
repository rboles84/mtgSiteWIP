...
- [VM-533 - Glint Semantic Recovery](in-progress/VM-533-glint-semantic-recovery.md) - exact semantic candidate `ed11a9194fb3d525b8b7cbf2c0ef8b304e6408c6` is ready for independent review; 5 substantive claims, 15 sources, 13 GLINT provenance rows with zero null IDs/hashes, 30 fixtures, UBRG/permutations fail closed, exact candidate-scope PASS, full validation PASS; no certification or program-base advancement.
