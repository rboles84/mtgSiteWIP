...
- [VM-532 - Yore Semantic Recovery](in-progress/VM-532-yore-semantic-recovery.md) - drift preflight and Gate 1+2 audit recorded from exact program base `4529f8615785743d074e3060e13f990941c1a458`; Gate 3+4 remediation authorized for YORE only, no candidate yet, and VM-533 remains backlog.
