...
**VM-502 Prismari, VM-506 Lorehold, VM-503 Quandrix, VM-504 Silverquill, VM-505 Witherbloom, VM-507 Izzet, VM-508 Azorius, VM-509 Boros, VM-510 Rakdos, VM-511 Golgari, VM-512 Gruul, VM-513 Dimir, VM-514 Orzhov, VM-515 Selesnya, VM-516 Simic, VM-517 White, VM-518 Blue, VM-519 Black, VM-520 Red, VM-521 Green, VM-522 Bant, VM-523 Esper, VM-524 Grixis, VM-525 Jund, VM-526 Naya, VM-527 Abzan, VM-528 Temur, VM-529 Sultai, VM-530 Mardu, VM-531 Jeskai, and VM-532 Yore are certified semantically ready under CRIT-001 Contract v1.1.** Yore exact candidate `f83b8b90b49a7afe3236f3e7f7ab52a254625d1f` is certified after independent exact-SHA review decision `APPROVE EXACT SHA f83b8b90b49a7afe3236f3e7f7ab52a254625d1f` at `3f012fa254816f27f2958c93fc5df742b445bb52`; candidate workflow record `80b83039aca88d66baf47486861e38caeb46b229` remains distinct from the semantic candidate. Wave 2 Ravnica is complete: 10 of 10 guild identities certified. Wave 3 monocolors are complete: 5 of 5 certified. Wave 4 shards are complete: 10 of 10 certified. Wave 5 four-color identities are 1 of 5 certified; total certified identities are 31. Current program base is `8145b8697ed1d1500c0faecf080b55404ab8ec4e` on `codex/crit001-program-base`. Prior program base was the VM-532 certification commit `8145b8697ed1d1500c0faecf080b55404ab8ec4e`. DRIFT-020 exact infrastructure candidate `399ba34243f5b421da4d3a0c251a37bcbc4bd5fa` remains certified and distinct. VM-533 Glint exact candidate `ed11a9194fb3d525b8b7cbf2c0ef8b304e6408c6` is approved by independent exact-SHA review decision `APPROVE EXACT SHA ed11a9194fb3d525b8b7cbf2c0ef8b304e6408c6` in `docs/handoffs/2026-07-23-2157-codex-vm533-glint-independent-review.md`; VM-533 is not certified and program base remains `8145b8697ed1d1500c0faecf080b55404ab8ec4e`. VM-534 Dune, VM-535 Ink, VM-536 Witch, VM-537 Colorless, and VM-538 WUBRG remain backlog and not started.
...
- [VM-533 - Glint Semantic Recovery](in-progress/VM-533-glint-semantic-recovery.md) - exact semantic candidate `ed11a9194fb3d525b8b7cbf2c0ef8b304e6408c6` is approved by independent exact-SHA review; 5 substantive claims, 15 sources, 13 GLINT provenance rows with zero null IDs/hashes, 30 fixtures, UBRG/permutations fail closed, exact candidate-scope PASS, full validation PASS; no certification or program-base advancement.
