...
- [VM-519 - Black Semantic Recovery](backlog/VM-519-black-semantic-recovery.md) - Gate 1+2 read-only audit complete with `REMEDIATION AUTHORIZED`; Gate 3+4 may proceed under the recorded Black source/evidence/frozen-field/preview/collision constraints. Candidate, review, certification, VM-520, and external tracker updates remain not started.
