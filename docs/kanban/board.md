...
- [VM-513 - Dimir Semantic Recovery](backlog/VM-513-dimir-semantic-recovery.md) - Gate 1+2 read-only audit complete; remediation authorized under Contract v1.1; not reviewed, not certified, and VM-514 not started.
