...
- [VM-516 - Simic Semantic Recovery](backlog/VM-516-simic-semantic-recovery.md) - Gate 1+2 read-only audit complete; decision `REMEDIATION AUTHORIZED`; no candidate, independent review, certification, semantically_ready transition, or VM-517 work started.
