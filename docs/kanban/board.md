...
- [VM-527 - Abzan Semantic Recovery](in-progress/VM-527-abzan-semantic-recovery.md) - drift preflight complete from exact VM-526 certification base; Gate 1+2 read-only audit authorized, with no semantic remediation or candidate yet.
