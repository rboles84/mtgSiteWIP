...
**VM-502 Prismari, VM-506 Lorehold, VM-503 Quandrix, VM-504 Silverquill, VM-505 Witherbloom, VM-507 Izzet, VM-508 Azorius, VM-509 Boros, VM-510 Rakdos, VM-511 Golgari, VM-512 Gruul, VM-513 Dimir, VM-514 Orzhov, and VM-515 Selesnya are certified semantically ready under CRIT-001 Contract v1.1.** Selesnya approved candidate `02252cbb24ec4ce615c85e8ad07d62d3be7db7e5` is accepted by independent Gate 5 review; candidate workflow-record SHA `1f88f03f7b6a582614f13a912024d0c9924926d7` and approval review SHA `6af0a2806dd7c26e71e4596839e25bbc51e1b5af` are recorded; superseded scope-failing candidate `5c9f69d752d1abf6b8f7790ddb4cce1206b64ad7` remains unapproved; reviewed WG provenance count is 70. VM-540 adds CRIT-001 Operating Playbook v2 and Gate 0 hardening. Active identity is VM-516 Simic / UG on `codex/vm-516-simic-semantic-recovery`; rejected Simic candidate `cbca9f596a090e924d532e7cb657c27c79ccb9de` received independent review decision `REQUEST CHANGES` for stale preview-eligible identity-layer public copy, and replacement candidate `bcc12c170e3d09fecd5b15c6ade07cef94ce7e1e` now has fresh independent review decision `APPROVE EXACT SHA bcc12c170e3d09fecd5b15c6ade07cef94ce7e1e`. Replacement workflow-record SHA `4db93dcf9d957ad89e5b5e3bfeedcbd6f564aa46` is recorded; the fresh review-record SHA is pending this governance commit. Superseded Simic candidates `f4afb9d5d769c72e1c86df189729423a380629af` and `204cf9e6be15f2c3ac59a36c3977efea9a9945ce` remain recorded as candidate-scope failures. Simic is approved but not certified, not semantically_ready, the program base remains `fbb81530b5932fd7913ba5f9e9d35d4f8e9ad6e3`, and VM-517 work has not started.
...
- [VM-516 - Simic Semantic Recovery](backlog/VM-516-simic-semantic-recovery.md) - Replacement candidate `bcc12c170e3d09fecd5b15c6ade07cef94ce7e1e` received fresh independent review decision `APPROVE EXACT SHA bcc12c170e3d09fecd5b15c6ade07cef94ce7e1e`; superseded candidates `f4afb9d5d769c72e1c86df189729423a380629af` and `204cf9e6be15f2c3ac59a36c3977efea9a9945ce` remain unapproved; certification pending; not semantically_ready; VM-517 not started.
