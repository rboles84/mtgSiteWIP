...
- [VM-522 - Bant Semantic Recovery](blocked/VM-522-bant-semantic-recovery.md) - mandatory drift preflight stopped before Gate 1+2 because Bant active-consumer candidate-scope proof chains are contaminated by unclassified raw claims, fixtures are missing, preview/provenance controls remain unknown, and raw/generated collision guidance has unresolved drift.
