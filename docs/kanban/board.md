...
- [VM-519 - Black Semantic Recovery](backlog/VM-519-black-semantic-recovery.md) - Independent review returned `REQUEST CHANGES` for exact candidate `5bffc3465786c18950d32dcb6f056504b3b8e668`; replacement candidate `0bfe8b3d46d163de6e20064f5de9717075ca02c8` remediates the stale/generic Black preview copy and awaits new independent review. Black is not certified and VM-520 remains not started.
