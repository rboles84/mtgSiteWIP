...
**VM-502 Prismari, VM-506 Lorehold, VM-503 Quandrix, VM-504 Silverquill, VM-505 Witherbloom, VM-507 Izzet, VM-508 Azorius, VM-509 Boros, VM-510 Rakdos, VM-511 Golgari, VM-512 Gruul, VM-513 Dimir, VM-514 Orzhov, VM-515 Selesnya, VM-516 Simic, VM-517 White, VM-518 Blue, and VM-519 Black are certified semantically ready under CRIT-001 Contract v1.1.** Black exact replacement candidate `0bfe8b3d46d163de6e20064f5de9717075ca02c8` is certified after independent review decision `APPROVE EXACT SHA 0bfe8b3d46d163de6e20064f5de9717075ca02c8`; rejected candidate `5bffc3465786c18950d32dcb6f056504b3b8e668` remains preserved and unapproved after `REQUEST CHANGES`. Wave 2 Ravnica is complete: 10 of 10 guild identities certified. Wave 3 monocolors are 3 of 5 certified, total certified identities 18. Current program base is the VM-519 Black certification SHA `1116786785dc4c5c8c1447dcad79c89e527657eb`. VM-520 Red / R exact candidate `deaf7a0bbaf9f2c91d2d00d302a38bef7f07b870` awaits independent review; Red is not approved, not certified, not `semantically_ready`, and VM-521 has not started.
...
- [VM-520 - Red Semantic Recovery](backlog/VM-520-red-semantic-recovery.md) - Gate 5 candidate `deaf7a0bbaf9f2c91d2d00d302a38bef7f07b870` created after Red remediation and validation; awaiting independent review, not approved, not certified, and VM-521 remains not started.
...
- [VM-519 - Black Semantic Recovery](done/VM-519-black-semantic-recovery.md) - certified semantically ready under CRIT-001 Contract v1.1 from exact approved replacement candidate `0bfe8b3d46d163de6e20064f5de9717075ca02c8`; rejected candidate `5bffc3465786c18950d32dcb6f056504b3b8e668` remains unapproved; reviewed B provenance count 25; certification commit recorded by this acceptance commit. VM-520 Red drift preflight passed; Gate 1+2 is authorized but not started.

- VM-520 candidate note: Red / R exact candidate `deaf7a0bbaf9f2c91d2d00d302a38bef7f07b870` was created after Gate 1+2 audit, Gate 3+4 remediation, generation, exact-chain proof, frozen-field proof, preview equality check, stale-copy scan, and validation. Final counts are 8 claims with 6 substantive, 0 discovery, 2 support, and 0 unclassified; R provenance has 25 entries, 0 required null canonical IDs, 0 required null content hashes, 0 unresolved pointers, and 0 duplicate canonical entries. Candidate-scope exits 1 only for the documented R DRIFT-015 display-source exception at `data/identity-layers.json` and global `data/factions.json` due the source-owned R preview plus embedded generated consumer. Red awaits independent review and is not approved, not certified, not semantically_ready; VM-521 remains not started.
