...
- [VM-518 - Blue Semantic Recovery](backlog/VM-518-blue-semantic-recovery.md) - Gate 1+2 read-only audit complete with `REMEDIATION AUTHORIZED`; Gate 3+4 may proceed under the recorded Blue source/evidence/frozen-field constraints. Candidate, review, certification, VM-519, and external tracker updates remain not started.
