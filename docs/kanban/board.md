...
- [VM-525 - Jund Semantic Recovery](in-progress/VM-525-jund-semantic-recovery.md) - pre-identity drift preflight complete from exact program base `16528f3a24a7f3d7f4475bdde56fbfee09becd98`; Gate 1+2 read-only audit authorized, with all semantic and candidate-readiness defects unresolved and no remediation/candidate/review/certification authorized.
