...
- [VM-524 - Grixis Semantic Recovery](ready/VM-524-grixis-semantic-recovery.md) - Exact candidate `64a5bfffd646b292c7481f91c9ccb6def42fb552` has its governance-only workflow recorded at `docs/handoffs/2026-07-21-0753-codex-vm524-grixis-candidate-workflow.md` and awaits fresh independent exact-SHA review; no approval, rejection, certification, semantically_ready transition, VM-525 work, Excel edit, CRIT ledger edit, or program-base advancement occurred.
## In Progress
