...
- [VM-530 - Mardu Semantic Recovery](in-progress/VM-530-mardu-semantic-recovery.md) - drift preflight and Gate 1+2 semantic audit complete from exact VM-529 certification/program base `7970c14822ce006c0d88f95cc6ed01bb3c79b81f`; Gate 3+4 MARDU-only remediation is authorized; candidate, independent review, certification, VM-531, Excel, cleanup, push, PR, and merge are not started.
