...
- [VM-517 - White Semantic Recovery](backlog/VM-517-white-semantic-recovery.md) - setup only after VM-516 certification; drift preflight pending; no White source inspection, Gate 1+2 audit, remediation, candidate, review, certification, or VM-518 work started.
