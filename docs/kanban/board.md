...
- [VM-550 - Strategium Final Visual Acceptance Refinement](in-progress/VM-550-strategium-after-game-mvp.md) - reopened from exact clean HEAD `1fa8fc6ab374ced5ea05377bf4e116ae3ebe5dd4` for one bounded unified hub panel, two-group readiness checklist, and Console hero-action removal pass.
