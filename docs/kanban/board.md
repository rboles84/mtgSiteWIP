...
- [VM-520 - Red Semantic Recovery](backlog/VM-520-red-semantic-recovery.md) - drift preflight passed after VM-519 Black certification; Red Gate 1+2 read-only audit is authorized but not started, and remediation remains unauthorized.
