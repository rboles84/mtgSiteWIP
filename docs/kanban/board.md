...
- [VM-522 - Bant Semantic Recovery](ready/VM-522-bant-semantic-recovery.md) - Gate 3+4 remediation is complete and validated at `b466cddb4618b1e2d7c897c15f7513a6d2db08b0`; Gate 5 candidate creation is authorized as a later separate workflow; no candidate exists, and review/certification remain unauthorized.
