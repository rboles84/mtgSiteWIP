...
- [VM-520 - Red Semantic Recovery](backlog/VM-520-red-semantic-recovery.md) - Exact replacement candidate `6aefb2090ff20a361f7f3cd80515445036323158` is independently approved after adding Red-local `JESKAI`, `JUND`, and `NAYA` neighbor coverage; rejected candidate `deaf7a0bbaf9f2c91d2d00d302a38bef7f07b870` remains unapproved; Red is not certified, and VM-521 remains not started.
...
- VM-520 replacement note: Red / R exact replacement candidate `6aefb2090ff20a361f7f3cd80515445036323158` remediates the `REQUEST CHANGES` blocker against rejected candidate `deaf7a0bbaf9f2c91d2d00d302a38bef7f07b870` by adding Red-local fixture/collision/recruiter guidance for `JESKAI`, `JUND`, and `NAYA`. Red received independent review decision `APPROVE EXACT SHA 6aefb2090ff20a361f7f3cd80515445036323158`; Red is not certified, not semantically_ready; certified count remains 18, Wave 3 remains 3 of 5, and VM-521 remains not started.
