...
**VM-502 Prismari, VM-506 Lorehold, VM-503 Quandrix, VM-504 Silverquill, VM-505 Witherbloom, VM-507 Izzet, VM-508 Azorius, VM-509 Boros, VM-510 Rakdos, VM-511 Golgari, VM-512 Gruul, VM-513 Dimir, VM-514 Orzhov, VM-515 Selesnya, VM-516 Simic, VM-517 White, VM-518 Blue, VM-519 Black, VM-520 Red, VM-521 Green, VM-522 Bant, VM-523 Esper, VM-524 Grixis, VM-525 Jund, VM-526 Naya, VM-527 Abzan, and VM-528 Temur are certified semantically ready under CRIT-001 Contract v1.1.** Temur exact candidate `790fca923c504e32911e0be0eb44f7fdbcfb07dc` is certified after independent exact-SHA review decision `APPROVE EXACT SHA 790fca923c504e32911e0be0eb44f7fdbcfb07dc` at `fc872d47d43f4338611a68f5dcc8b8293904af26`; candidate workflow record `3e05170dde802a135182c80af641c72962ddcba8` remains distinct from the semantic candidate. Wave 2 Ravnica is complete: 10 of 10 guild identities certified. Wave 3 monocolors are complete: 5 of 5 certified. Wave 4 shards are active: 7 of 10 certified, 1 in progress, and 2 backlog; total certified identities remain 27. Current program base remains the VM-528 certification commit `8e23ef467ec7f60daec746c14493173f96d9261c`; the prior program base was the VM-527 certification commit `a1632337ebc91950b37d835ac404fba414f770c7`. DRIFT-020 exact infrastructure candidate `399ba34243f5b421da4d3a0c251a37bcbc4bd5fa` remains certified and distinct. VM-529 Sultai exact semantic candidate `a92fb3f8a0ec4235d5148b20c4040bd717332ad6` is approved by independent exact-SHA review decision `APPROVE EXACT SHA a92fb3f8a0ec4235d5148b20c4040bd717332ad6` and awaits certification-only governance; no Sultai certification, semantically_ready transition, program-base change, certified-count change, or VM-530 work has occurred.
...
- [VM-529 - Sultai Semantic Recovery](in-progress/VM-529-sultai-semantic-recovery.md) - exact semantic candidate `a92fb3f8a0ec4235d5148b20c4040bd717332ad6` is approved by independent exact-SHA review and awaits certification-only governance; no certification, semantically_ready transition, program-base change, certified-count change, VM-530, or Excel work has occurred.
