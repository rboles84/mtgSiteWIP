...
- [VM-519 - Black Semantic Recovery](backlog/VM-519-black-semantic-recovery.md) - Independent review returned `REQUEST CHANGES` for exact candidate `5bffc3465786c18950d32dcb6f056504b3b8e668`; replacement candidate required for stale/generic Black preview copy. Black is not certified and VM-520 remains not started.
