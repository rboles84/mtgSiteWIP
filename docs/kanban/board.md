...
- [VM-525 - Jund Semantic Recovery](in-progress/VM-525-jund-semantic-recovery.md) - Gate 1+2 read-only semantic audit complete from starting HEAD `f189c2f5b6a758e928934fca45a77d879f70a7d4` and exact program base `16528f3a24a7f3d7f4475bdde56fbfee09becd98`; Gate 3+4 remediation authorized by governance contract, with no remediation/candidate/review/certification performed.
