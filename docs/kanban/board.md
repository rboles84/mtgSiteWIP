...
**VM-502 Prismari, VM-506 Lorehold, VM-503 Quandrix, VM-504 Silverquill, VM-505 Witherbloom, VM-507 Izzet, VM-508 Azorius, VM-509 Boros, VM-510 Rakdos, VM-511 Golgari, VM-512 Gruul, VM-513 Dimir, VM-514 Orzhov, VM-515 Selesnya, VM-516 Simic, VM-517 White, VM-518 Blue, VM-519 Black, VM-520 Red, VM-521 Green, VM-522 Bant, VM-523 Esper, VM-524 Grixis, VM-525 Jund, VM-526 Naya, VM-527 Abzan, VM-528 Temur, VM-529 Sultai, and VM-530 Mardu are certified semantically ready under CRIT-001 Contract v1.1.** Mardu exact candidate `96df085ff38d03da1e37de80b1e11705b1dfa47a` is certified after independent exact-SHA review decision `APPROVE EXACT SHA 96df085ff38d03da1e37de80b1e11705b1dfa47a` at `f3b360ec0d9df569f585299480db1f34ba72a01b`; candidate workflow record `ab961e384ef72bd4c56dae07f60863016511adb0` remains distinct from the semantic candidate. Wave 2 Ravnica is complete: 10 of 10 guild identities certified. Wave 3 monocolors are complete: 5 of 5 certified. Wave 4 shards are active: 9 of 10 certified and 1 in progress; total certified identities are 29. Current program base is `9b91bbe0631ecdb45f38823ecc0fdc70bd7c12a2` on `codex/crit001-program-base`. Prior program base was the VM-529 certification commit `7970c14822ce006c0d88f95cc6ed01bb3c79b81f`. DRIFT-020 exact infrastructure candidate `399ba34243f5b421da4d3a0c251a37bcbc4bd5fa` remains certified and distinct. VM-531 Jeskai exact candidate `9ac575a89eca55f8bc3522083e51689f29ebd262` is recorded on `codex/vm-531-jeskai-semantic-recovery` and awaits independent review; no certification or program-base advancement has occurred.
...
- [VM-531 - Jeskai Semantic Recovery](in-progress/VM-531-jeskai-semantic-recovery.md) - exact semantic candidate `9ac575a89eca55f8bc3522083e51689f29ebd262` created and awaiting independent review; no certification or program-base advancement.
