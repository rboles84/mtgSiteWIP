...
**VM-502 Prismari, VM-506 Lorehold, VM-503 Quandrix, VM-504 Silverquill, VM-505 Witherbloom, VM-507 Izzet, VM-508 Azorius, VM-509 Boros, VM-510 Rakdos, VM-511 Golgari, VM-512 Gruul, VM-513 Dimir, VM-514 Orzhov, VM-515 Selesnya, VM-516 Simic, VM-517 White, VM-518 Blue, VM-519 Black, and VM-520 Red are certified semantically ready under CRIT-001 Contract v1.1.** Red exact replacement candidate `6aefb2090ff20a361f7f3cd80515445036323158` is certified after independent review decision `APPROVE EXACT SHA 6aefb2090ff20a361f7f3cd80515445036323158`; rejected candidate `deaf7a0bbaf9f2c91d2d00d302a38bef7f07b870` remains preserved and unapproved after `REQUEST CHANGES`; no superseded Red replacement candidate exists. Wave 2 Ravnica is complete: 10 of 10 guild identities certified. Wave 3 monocolors are 4 of 5 certified, total certified identities 19. Current program base is the VM-520 Red certification SHA placeholder `PENDING_VM520_CERTIFICATION_COMMIT_SHA` inside tracked governance. VM-542 resolves the VM-541 NDJSON/JS active-consumer ambiguity with `PASS - NDJSON PROVENANCE AND DEPENDENCY RESOLVED`: active runtime/build/test preview defect count is 0 for the four audited files. VM-521 Green / G is setup-only with drift preflight pending; Green Gate 1+2, semantic inspection, remediation, candidate, review, certification, and VM-522 work have not started.
...
- [VM-521 - Green Semantic Recovery](backlog/VM-521-green-semantic-recovery.md) - Setup-only after VM-520 Red certification; drift preflight pending, Gate 1+2 not started, and Green semantic data remains uninspected.
...
- [VM-541 - Certified Preview Consumer Audit](done/VM-541-certified-preview-consumer-audit.md) - read-only CRIT-001 audit from program base `9f0a076a369cba23dc9bc19231b0efcddd21afe5`; confirmed stale copied preview strings for Silverquill, Azorius, Gruul, Simic, Black, and Red; source JSON and embedded generated JSON pass for all 19 certified identities; its active-consumer classification is superseded by VM-542 provenance/dependency audit.

- [VM-542 - NDJSON Provenance Audit](done/VM-542-ndjson-provenance-audit.md) - governance-only audit resolves the VM-541 active-consumer ambiguity; both top-level workbook inspect NDJSON files are `DEBUG_INSPECTION_ARTIFACT`, both audited color-matrix JS files are `HISTORICAL_ARCHIVE`, and no runtime repair is recommended for those four files.
