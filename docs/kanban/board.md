...
- [VM-518 - Blue Semantic Recovery](backlog/VM-518-blue-semantic-recovery.md) - Setup-only branch state after VM-517 certification. Blue drift preflight and Gate 1+2 semantic work are not started; a separate committed drift-preflight control record is required before any semantic work.
