...
- [VM-522 - Bant Semantic Recovery](blocked/VM-522-bant-semantic-recovery.md) - mandatory drift preflight and stop-line rerun both stopped before Gate 1+2; read-only tracing now proves active consumers, but Bant remains blocked by unclassified raw claims, missing evidence scopes and fixtures, null provenance canonical IDs, candidate-scope failure, stale generated provenance, unresolved preview/consumed-surface semantic alignment, required-neighbor gaps, and raw/generated collision drift.
