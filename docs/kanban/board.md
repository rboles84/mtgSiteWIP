...
- [VM-524 - Grixis Semantic Recovery](in-progress/VM-524-grixis-semantic-recovery.md) - pre-identity drift preflight complete at `docs/handoffs/2026-07-20-2155-codex-vm524-grixis-drift-preflight.md`; Gate 1+2 read-only audit authorized for a later separate prompt; all semantic/candidate-readiness defects remain unresolved; no remediation, candidate, review, certification, Excel edit, or program-base advancement occurred.
