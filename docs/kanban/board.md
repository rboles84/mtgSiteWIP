...
- [VM-518 - Blue Semantic Recovery](backlog/VM-518-blue-semantic-recovery.md) - Drift preflight passed; Gate 1+2 read-only audit is authorized but not started. Remediation, generated rebuilds, fixture creation, candidate, review, certification, VM-519, and external tracker updates remain not started.
