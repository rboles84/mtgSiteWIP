...
- [VM-523 - Esper Semantic Recovery](ready/VM-523-esper-semantic-recovery.md) - exact candidate `6467f70fa4de13173172e20277e0fd56ebaf0b80` is independently approved by `docs/handoffs/2026-07-20-1914-codex-vm523-esper-independent-review.md`; certification-only window is required next; no certification, semantically-ready transition, certified-count increment, program-base advancement, VM-524 work, or Excel edit exists.
## In Progress
