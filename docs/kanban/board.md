...
- [VM-522 - Bant Semantic Recovery](ready/VM-522-bant-semantic-recovery.md) - Replacement candidate `5522e8494a0d1a61b6aa85b0c5edf1ddb9c015d8` is recorded and awaiting fresh independent exact-SHA review; rejected candidate `b466cddb4618b1e2d7c897c15f7513a6d2db08b0` remains rejected and preserved. Certification remains prohibited and Bant is not `semantically_ready`.
