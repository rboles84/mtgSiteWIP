...
- [VM-524 - Grixis Semantic Recovery](in-progress/VM-524-grixis-semantic-recovery.md) - Gate 1+2 read-only semantic audit complete at `docs/handoffs/2026-07-20-2239-codex-vm524-grixis-gate1-gate2.md`; Gate 3+4 remediation authorized for a later separate prompt; all semantic/candidate-readiness defects remain unresolved until remediation; no remediation, candidate, review, certification, Excel edit, VM-525 work, or program-base advancement occurred.
