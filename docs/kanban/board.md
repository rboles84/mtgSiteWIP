...
**VM-502 Prismari, VM-506 Lorehold, VM-503 Quandrix, VM-504 Silverquill, VM-505 Witherbloom, and VM-507 Izzet are certified semantically ready under CRIT-001 Contract v1.1.** VM-508 Azorius recovery candidate `221a19b690cad02fb9aba2c91ae506b6d4fcc205` is pending independent Gate 5 review and Azorius remains uncertified. Known Azorius warnings remain unchanged: builder-owned inhibitor warning and dossier audit verified 37 primary dossiers, 76 adjacent dossiers, 113 warnings, 0 failures. Candidate-scope display-source exception is limited to `data/factions.json` WU/Azorius display cleanup and `data/identity-layers.json#/expressions/WU/preview_text`.
