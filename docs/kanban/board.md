...
- [VM-517 - White Semantic Recovery](backlog/VM-517-white-semantic-recovery.md) - governance hold after drift preflight; shared infrastructure candidate `aa1f5cd174a09c7c99e17e3ecf882bf4e03dbdb2` removes the monocolor validator crash and awaits independent exact-SHA review. White Gate 1+2 remains not authorized; no White source inspection, semantic audit, remediation, candidate, review, certification, or VM-518 work started.
