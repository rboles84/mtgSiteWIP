...
- [VM-550 - Strategium Hub Navigation Regression Remediation](done/VM-550-strategium-after-game-mvp.md) - implementation and validation complete from exact clean candidate `43e0ed0cc0436dc9c0da38d4eff1e980e058b00f`; desktop, cloned mobile, and footer Strategium links return to the canonical hub while Console-local anchors remain intact; awaiting owner hand review of the new exact validation-and-handoff HEAD, then repetition of the independent review gate against that SHA.
