...
- [VM-516 - Simic Semantic Recovery](backlog/VM-516-simic-semantic-recovery.md) - drift preflight passed; Gate 1+2 read-only audit is authorized but not started; no Simic remediation, generation, candidate, independent review, certification, semantically_ready transition, or VM-517 work started.
