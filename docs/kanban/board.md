...
- [VM-522 - Bant Semantic Recovery](ready/VM-522-bant-semantic-recovery.md) - Exact candidate `b466cddb4618b1e2d7c897c15f7513a6d2db08b0` is recorded and awaiting independent exact-SHA review; review decision and certification remain unauthorized, and Bant is not `semantically_ready`.
