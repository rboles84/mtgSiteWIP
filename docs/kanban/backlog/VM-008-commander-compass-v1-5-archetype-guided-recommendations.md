...
- `docs/architecture/project-atlas.md` - describes Commander recommendations as a presenter-layer surface fed by the placement result and routed commander links.
