...
- Independent reviewer: pending for replacement candidate
...
- Gruul replacement candidate exists after review remediation and is awaiting a new independent review; Gruul is not certified.
...
- Validation: passed.
- Current status: replacement candidate awaiting independent review.
- Certification: not performed.
- `semantically_ready`: not set.
- VM-513: not started.
