...
expect(
  sources.archscry.includes('<link rel="stylesheet" href="../assets/css/archscry.css?v=vm625g">'),
...
const archscryRouteCssIndex = sources.archscry.lastIndexOf('../assets/css/archscry.css?v=vm625g');
expect(
