...
assert.match(indexSource, /renderedEducationalTerms\.get\(semanticBlock\)/, "glossary should decorate the first canonical term occurrence in each semantic block");
